...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String PATH_WEATHER_WEAR = "/weather";
    ...
    private void weatherToWatchFace() {
        ...
        if (!connectionResult.isSuccess()) {
            Log.e(LOG_TAG, "Not connected to google api fawaz ");
            return;
        }
        Log.e(LOG_TAG, " connected to google api fawaz ");

        // Send data to Wearable using MapRequest
        PutDataMapRequest mapRequest = PutDataMapRequest.create(PATH_WEATHER_WEAR);
        DataMap dataMap = mapRequest.getDataMap();
        dataMap.putString(KEY_HIGH, Utility.formatTemperature(context, high));
        dataMap.putString(KEY_LOW, Utility.formatTemperature(context,low));
        dataMap.putInt(KEY_ID, weatherId);
    ...
    private void notifyWeather() {
        ...
        if ( displayNotifications ) {
            ...
            long lastSync = prefs.getLong(lastNotificationKey, DAY_IN_MILLIS);
